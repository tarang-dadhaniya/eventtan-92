...
@Component({
  ...
  template: `
      ...
      <main class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="flex-1 overflow-auto p-4 lg:p-8">
          ...
          <div class="flex items-center justify-center mb-8 gap-0">
            <!-- Admin Tab (Active) -->
            <button
              class="px-6 py-3 font-semibold rounded-l transition-colors bg-primary-blue text-white shadow-md"
            >
            ...
            <!-- Managers Tab -->
            <button
              (click)="navigateToEventManagers()"
              class="px-6 py-3 font-medium rounded-r transition-colors border-2 border-primary-blue text-primary-blue bg-white"
            >
              Event Managers
            </button>
          </div>
                      ...
                      <div class="flex justify-center">
                        ...
                        >
                          <div
                            ...
                            [class.ml-auto]="user.status === 'active'"
                            [class.bg-[#06A947]]="user.status === 'active'"
                            [class.bg-gray-400]="user.status !== 'active'"
                          ></div>
                        </div>
                      </div>
                    </td>
    ...
    >
      ...
      >
        <div class="p-8">
          <h2 class="text-[22px] font-medium text-[#212529] mb-8">
            {{ isEditMode ? "Edit User" : "Invite Organization Admin" }}
          </h2>
          ...
          <form (ngSubmit)="onSubmit()" #addPersonForm="ngForm">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full h-[50px] px-5 border-2 border-[#E9EBEC] rounded text-[#434349] placeholder-[#434349] focus:outline-none focus:border-primary-blue"
                />
              </div>
            ...
            <div class="flex justify-end gap-4">
              <button
                ...
                class="h-9 px-6 border-2 border-gray-300 rounded text-gray-700 font-semibold hover:bg-gray-50 transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                class="h-9 px-6 bg-primary-blue hover:bg-[#0385b5] text-white font-semibold rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
...
export class ManageUserComponent implements OnInit {
  ...
  navigateToEventManagers() {
    this.router.navigate(["/event-managers"]);
  }
